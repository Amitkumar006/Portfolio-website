        ...
        <div id='about' className='about'>
            ...
            <div className="about-right">
                ...
                <div className="about-skills">
                    <div className="about-skill"><p>NAME </p>           <p>:</p>             <p>AMIT KUMAR</p></div>
                    <div className="about-skill"><p>EMAIL</p>          <p> : </p>           <p> amitkumarprajapat.ak@gmail.com</p></div>
                    <div className="about-skill"><p>DATE OF BIRTH</p>  <p> :</p>             <p>1 Aug 2002</p></div>
                    <div className="about-skill"><p>PHONE</p>           <p>:</p>             <p>+91 8107431817</p></div>
                    <div className="about-skill"><p>ADDRESS</p>         <p>:</p>             <p>PILANI, RAJASTHAN</p></div>
